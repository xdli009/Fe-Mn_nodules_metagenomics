...
for bins in dict1.keys():
	...
	faa_path = "/beegfs/home/lxd/2_sea_metagenomics/6.metabat2/bins_redup_refinem_drep/derep_70_10/derepbins_prodigal/faa/" + bins + ".proteins.faa" 
	...
	cp_genome = "cp /beegfs/home/lxd/2_sea_metagenomics/6.metabat2/bins_redup_refinem_drep/derep_70_10/dereplicated_genomes/fa_newid_newcontigid/" + bins + ".fa ./" + bins + "/" + bins + "_genome.fna"
	os.system(cp_genome)
	cp_faa = "cp /beegfs/home/lxd/2_sea_metagenomics/6.metabat2/bins_redup_refinem_drep/derep_70_10/derepbins_prodigal/faa/" + bins + ".proteins.faa ./" + bins + "/" + bins + "_proteins.faa"
	os.system(cp_faa)	
