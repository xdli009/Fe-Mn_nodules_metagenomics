library(ggplot2)
data <- read.csv("sir.csv", header = T, check.names = F)
data$phylum <- factor(data$phylum,levels = c("Proteobacteria","Desulfobacterota_D","Methylomirabilota","Myxococcota_A","Thermoproteota","Actinobacteriota"))
mycol <- c("#d4a6c8","#a0cbe8","#ff9d9a","#b07aa1","#00a98f","#d37295")
...
ggsave("sir.pdf",p,width = 8,height = 8)