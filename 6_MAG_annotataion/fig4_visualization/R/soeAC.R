library(ggplot2)
data <- read.csv("soeAC.csv", header = T, check.names = F)
data$phylum <- factor(data$phylum,levels = c("Proteobacteria","Desulfobacterota_B","Thermoproteota","Planctomycetota","Acidobacteriota"))
mycol <- c("#d4a6c8","#fabfd2","#00a98f","#f1ce63","#4e79a7")
...
ggsave("soeAC.pdf",p,width = 8,height = 8)