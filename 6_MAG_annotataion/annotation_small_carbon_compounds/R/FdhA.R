library(ggplot2)
data <- read.csv("FdhA.csv", header = T, check.names = F)
data$phylum <- factor(data$phylum,levels = c("Proteobacteria","Chloroflexota","Latescibacterota"))
mycol <- c("#d4a6c8","#e15759","#d7b5a6")
...
ggsave("FdhA.pdf",p,width = 8,height = 8)