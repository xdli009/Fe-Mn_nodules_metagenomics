...
## 6_MAG_annotataion
  ...
  * #### annotation_small_carbon_compounds
    * #### simple_compounds_ko_id_phylum.txt
    ...
    * #### simple_compounds_ko_id_phylum_redup.txt
    ...
    * #### simple_compounds_ko_id_phylum_redup_order.csv
      The result of the above python script.
    * #### simple_compounds_ko_id_phylum_redup_order_excel.csv
    ...
    * #### matrix_simple_compounds_ko.txt (Table S11)
...
## 7_key_MAGs
  ...
  * #### low_abundance_each_18
    ...
    * #### Figure_S6.pdf
      PDF file of Fig. S6. (The images were generated by combining above picture and table using Adobe Illustrator.)
    * #### Figure_S6.tif
      The TIFF format of Fig. S6.
