...
fr_high = open("../7_dominant_MAGs/high_abundance_bin_id.txt","r").read().splitlines()
list_high = []
for line in fr_high:
	list_high.append(line)
fw = open("get_all_key.txt","w")
fw.write("Gene name" + "\t" + "The width of line represent abundance of dominant MAGs" + "\t" + "The width of line represent abundance of other MAGs" + "\t" + "The width of line represent abundance of all MAGs" + "\t" + "Percentage of the abundance of dominant MAGs (%)" + "\t" + "Percentage of the abundance of other MAGs (%)" + "\n")
